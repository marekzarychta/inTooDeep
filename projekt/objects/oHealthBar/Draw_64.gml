...
draw_sprite(sHealthBar, 0, x+sprite_get_width(sHeart), y);  // Rysuj główny sprite na wyliczonych współrzędnych
...
for (var i = 0; i < oPlayer.current_health; i++) {
    var xx =  x+sprite_get_width(sHeart) + 24 + i * stretch;  // Dopasowanie do szerokości
    draw_sprite_stretched(sHealthPoint, 0, xx, y + height/10, stretch, height*0.8);  // Rysowanie zdrowia
}
