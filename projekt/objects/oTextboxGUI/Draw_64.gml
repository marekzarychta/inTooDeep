...
if (left) {
	draw_set_halign(fa_left);
	draw_text(drawX + 36 , drawY-8+string_height(textVal)/2, textVal);
} else {
	draw_set_halign(fa_right);
	draw_text(drawX - 4 , drawY-8+string_height(textVal)/2, textVal);
}

draw_sprite_stretched(key_icon, 0, drawX, drawY + 16, 32, 32);
