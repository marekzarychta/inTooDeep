...
if (!gui) {
	...
	var upKey = keyboard_check_pressed(ord("W")) + keyboard_check_pressed(vk_up) + gamepad_button_check_pressed(0,gp_padu);
    upKey = clamp(upKey, 0, 1);

    var downKey = keyboard_check_pressed(ord("S")) + keyboard_check_pressed(vk_down) + gamepad_button_check_pressed(0,gp_padd);
